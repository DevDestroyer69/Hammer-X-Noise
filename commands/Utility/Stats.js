 ...
 */
    ...
    let ownerIV = this.client.users.cache.has(this.client.config.owners[3].id) ? this.client.users.cache.get(this.client.config.owners[3].id).tag : 'Unknown#0000';
    let s1 = this.client.users.cache.has(this.client.config.supporter[0].id) ? this.client.users.cache.get(this.client.config.supporter[0].id).tag : 'Unknown#0000';
    let s2 = this.client.users.cache.has(this.client.config.supporter[1].id) ? this.client.users.cache.get(this.client.config.supporter[1].id).tag : 'Unknown#0000';
...
› Version: 3.0.8
› Developer: Developed by Hammer Tech
